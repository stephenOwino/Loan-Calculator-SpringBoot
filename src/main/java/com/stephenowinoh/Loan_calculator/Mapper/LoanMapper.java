...
public class LoanMapper {
                ...
                public static LoanDTO toDto(Loan loan) {
                        ...
                        loanDto.setRepaymentFrequency(loan.getRepaymentFrequency());  // Ensure no conversion needed here
                ...
                public static Loan toEntity(LoanDTO loanDto) {
                        ...
                        if (loanDto.getRepaymentFrequency() != null) {
                                loan.setRepaymentFrequency(RepaymentFrequency.valueOf(loanDto.getRepaymentFrequency().name()));  // Ensuring correct enum mapping
                        }
